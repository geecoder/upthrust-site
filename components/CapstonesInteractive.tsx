...
const CAPSTONES = [
  {
    ...
    context: 'A leading Nigerian digital wallet has a 58% drop-off at the BVN/NIN identity verification step. Users start the onboarding flow but abandon at the point of identity confirmation.',
  ...
  },
  {
    ...
    region: 'UK / Diaspora',
    industry: 'Fintech',
    title: 'Multi-Currency Savings Product for African Diaspora',
    context: 'A UK-based fintech serving the African diaspora wants to launch a savings product that allows users to save in GBP, USD, and NGN simultaneously — with cross-border transfer capability on maturity.',
  ...
  },
  {
    ...
    context: 'A Nigerian health-tech startup wants to build a mobile platform that helps lower-income users navigate public and private health services — booking, triaging symptoms, and finding affordable care options in their local area.',
  ...
  },
  {
    ...
    title: 'SME Invoice, Inventory & Payment Management Tool',
    context: 'Small business owners in Lagos and Accra are managing inventory, invoicing, and supplier payments across WhatsApp, Excel, and paper. A fintech startup wants to replace this with a simple digital product.',
  ...
  },
  {
    ...
    context: 'A Nigerian logistics startup handling 500+ deliveries per day is losing 23% of packages to wrong addresses, driver no-shows, and communication failures. They need a product that connects dispatchers, drivers, and customers.',
  ...
  },
  {
    ...
    region: 'UK / Canada',
    industry: 'Proptech',
    title: 'Rental Application & Tenancy Management Platform',
    context: 'A UK proptech startup wants to digitise the end-to-end rental process for letting agents and tenants — from application and referencing, through tenancy agreement, to maintenance requests and rent collection.',
  ...
  },
  {
    ...
    industry: 'Edtech',
    title: 'Student Learning Management and Progress Tracking Platform',
    context: 'An African online learning startup is running courses across 12 countries. Students are dropping off mid-course at 67%. Instructors have no visibility into student progress. There is no structured feedback loop.',
  ...
  },
  {
    ...
    title: 'Beneficiary Management and Grant Disbursement Platform',
    context: 'A West African NGO distributing livelihood grants to 10,000 rural beneficiaries is managing everything through Excel, field agents, and paper forms. Disbursement delays, data errors, and duplicate payments are costing the program 18% waste.',
