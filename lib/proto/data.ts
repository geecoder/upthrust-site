...
export const ASK: Record<ProgKey, { q: string; a: string }[]> = {
  pm: [
    ...
    { q: "How long is the Product Management program?", a: "The program runs for approximately 13 weeks, combining structured learning, practical exercises, project work and mentor support." },
  ...
  ba: [
    ...
    { q: "How long is the Business Analysis program?", a: "The Upthrust capability program runs for approximately 13 weeks, combining structured learning with practical exercises, projects and mentor support." },
  ...
  pd: [
    ...
    { q: "How long is the Product Design program?", a: "The program runs for approximately 13 weeks, combining structured learning, practical exercises, project work and mentor support." },
