          ...
          <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-amber/10 border border-amber/20 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-amber text-xs font-bold tracking-widest uppercase">PM Pathway · Cohort 1 Open</span>
              </div>
              <h1
              ...
              >
                Build evidence as a
                <br />
                <span className="text-amber italic">Product Manager.</span>
              </h1>
